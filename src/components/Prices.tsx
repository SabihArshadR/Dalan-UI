  ...
  return (
    <div className="w-full bg-white py-20">
      <div className="text-center max-w-3xl mx-auto">
        <h2 className="text-[40px] font-bold tracking-widest text-[#414141] font-montserrat">
      ...
      <div className="mt-16 grid lg:grid-cols-4 gap-8 max-w-7xl mx-auto px-6">
        ...
        <div className="shadow-md bg-[#F6F6F6] py-12 px-10 text-center rounded-md">
          ...
          <h4 className="tracking-widest text-gray-700 mb-6">
            BUILDING
          </h4>
        ...
        {/* Box */}
        <div className="shadow-md bg-gray-50 py-12 px-10 text-center rounded-md">
          <h3 className="text-[#FFCD23] text-5xl">$ 30</h3>
          <p className="text-[#FFCD23] mb-6">/Month</p>
        ...
        {/* Box */}
        <div className="shadow-md bg-gray-50 py-12 px-10 text-center rounded-md">
          <h3 className="text-[#FFCD23] text-5xl">$ 70</h3>
          <p className="text-[#FFCD23] mb-6">/Month</p>
        ...
        {/* Box */}
        <div className="shadow-md bg-gray-50 py-12 px-10 text-center rounded-md">
          <h3 className="text-[#FFCD23] text-5xl">$ 90</h3>
          <p className="text-[#FFCD23] mb-6">/Month</p>
